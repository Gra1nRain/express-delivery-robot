...
# 方块仍要求检测框完整离开画面边缘并连续两帧稳定，接受阈值恢复为 0.50。
# 瓶子继续沿用上面的 0.50 单帧定位策略。
export WRIST_BLOCK_COMPLETE_DETECTION_CONFIDENCE="${WRIST_BLOCK_COMPLETE_DETECTION_CONFIDENCE:-0.50}"
export WRIST_BLOCK_DETECTION_CONFIRM_FRAMES="${WRIST_BLOCK_DETECTION_CONFIRM_FRAMES:-2}"
export WRIST_BLOCK_DETECTION_CONFIRM_MIN_IOU="${WRIST_BLOCK_DETECTION_CONFIRM_MIN_IOU:-0.50}"
export WRIST_TARGET_BBOX_EDGE_MARGIN_PX="${WRIST_TARGET_BBOX_EDGE_MARGIN_PX:-12}"
...
# 默认让夹爪 TCP 对准点云中心；如实测存在固定误差，可在外部显式 export 微调。
export WRIST_GRASP_RIGHT_BIAS_M="${WRIST_GRASP_RIGHT_BIAS_M:-0.0}"
export WRIST_GRASP_LEFT_COMPENSATION_M="${WRIST_GRASP_LEFT_COMPENSATION_M:-0.0}"
...
export WRIST_BOTTLE_FORWARD_EXTRA_M="${WRIST_BOTTLE_FORWARD_EXTRA_M:-0.055}"
export WRIST_BOTTLE_GRASP_HEIGHT_FRACTION="${WRIST_BOTTLE_GRASP_HEIGHT_FRACTION:-0.25}"
export WRIST_BOTTLE_GRASP_MIN_ABOVE_BOTTOM_M="${WRIST_BOTTLE_GRASP_MIN_ABOVE_BOTTOM_M:-0.020}"
...
export WRIST_BLOCK_GRASP_LEFT_SHIFT_M="${WRIST_BLOCK_GRASP_LEFT_SHIFT_M:-0.035}"
export WRIST_BLOCK_FORWARD_EXTRA_M="${WRIST_BLOCK_FORWARD_EXTRA_M:-0.040}"
export WRIST_BLOCK_EXTRA_DESCENT_M="${WRIST_BLOCK_EXTRA_DESCENT_M:-0.020}"
export WRIST_GRASP_AXIS_YAW_OFFSET_DEG="${WRIST_GRASP_AXIS_YAW_OFFSET_DEG:-0.0}"
...
export WRIST_BLOCK_TOP_DOWN_MIN_FLANGE_Y_M="${WRIST_BLOCK_TOP_DOWN_MIN_FLANGE_Y_M:--0.545}"
# 方块只在安全预抓位完成姿态调整；最后锁定世界 X/RPY，沿世界 -Y/-Z 前下方进给。
export WRIST_BLOCK_TERMINAL_PITCH_CANDIDATES_DEG="${WRIST_BLOCK_TERMINAL_PITCH_CANDIDATES_DEG:-30,35,40}"
export WRIST_BLOCK_TERMINAL_YAW_OFFSETS_DEG="${WRIST_BLOCK_TERMINAL_YAW_OFFSETS_DEG:-0,-20,20}"
export WRIST_BLOCK_FINAL_APPROACH_Y_M="${WRIST_BLOCK_FINAL_APPROACH_Y_M:-0.030}"
export WRIST_BLOCK_FINAL_APPROACH_Z_M="${WRIST_BLOCK_FINAL_APPROACH_Z_M:-0.050}"
export WRIST_BLOCK_MIN_JOINT_MARGIN_RAD="${WRIST_BLOCK_MIN_JOINT_MARGIN_RAD:-0.150}"
export WRIST_BLOCK_PREGRASP_MIN_FLANGE_Z_M="${WRIST_BLOCK_PREGRASP_MIN_FLANGE_Z_M:-0.150}"
export WRIST_BLOCK_PREGRASP_MAX_JOINT_TRAVEL_RAD="${WRIST_BLOCK_PREGRASP_MAX_JOINT_TRAVEL_RAD:-2.000}"
export WRIST_BLOCK_LOCKED_PATH_SAMPLES="${WRIST_BLOCK_LOCKED_PATH_SAMPLES:-24}"
export WRIST_BLOCK_LOCKED_PATH_MAX_JOINT_STEP_RAD="${WRIST_BLOCK_LOCKED_PATH_MAX_JOINT_STEP_RAD:-0.150}"
